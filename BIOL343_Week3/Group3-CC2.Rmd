...
Hist_cc1_cleandata=ggplot(aes(x = ovary_area), data=cc1_cleandata) + geom_histogram(binwidth=0.8) + theme_classic() +  labs(title = "Ovary Area Between Populations", subtitle = "(Asexual vs. Sexual)", x = expression("Ovary Area (" * mm^2 * ")"), y="Count")
