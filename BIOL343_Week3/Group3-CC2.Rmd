...
#Confirm that include=F is the correct choice? 
```
...
labs(title = "Ovary Area Between Populations", subtitle = "(Asexual vs. Sexual)", x = "Population Type", y = "Ovary Area (mm²)")
...
# Can scale_colour_gradient be used to seperate the 2 pop types into 2 diff. colours? 
```
...
#Is the listing of the source correct?
Source: source("https://onq.queensu.ca/d2l/lms/dropbox/user/folder_submit_files.d2l?db=492096&grpid=1208698&isprv=0&bp=0&ou=1208667")
