...
```{r area-table, echo=F}
#Confirm that the echo=F choice is correct (what did other use?)
...
```{r area-histogram}
Hist_cc1_cleandata=ggplot(aes(x = ovary_area), data=cc1_cleandata) + geom_histogram(binwidth=0.8) + theme_classic() +  
labs(title = "Ovary Area Between Populations", subtitle = "(Asexual vs. Sexual)", x = "Population Type", y = "Ovary Area (mm²)") #+ scale_colour_gradient2(high="blue", low="red")

Hist_cc1_cleandata

Hist2_cc1_cleandata=Hist_cc1_cleandata + facet_wrap(vars(populationtype))
Hist2_cc1_cleandata
